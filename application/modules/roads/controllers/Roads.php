...
class ROADS extends MX_Controller
{
    ...
    function index()
    {
        ...
        $this->data['title'] = 'Rural Roads(2025)';
        $this->data['heading'] = 'Master - Rural Roads(2025)';
        $this->data['subheading'] = 'Rural Roads(2025)';
    ...
    //             if (trim($row->road_type) == 'Bituminious(Tar)Road') {
    //                 $update_data['bt_length'] = $row->length;
    //             } elseif (trim($row->road_type) == 'Concrete Road') {
    //                 $update_data['cc_length'] = $row->length;
    //             }
    ...
    function entry($id = 0)
    {
        ...
        if ($id > 0) {
            ...
            $selected = array(
                ...
                'proposed_length' => $row->proposed_length,
                'length' => $row->length,
        ...
        $this->data['title'] = 'Rural Roads(2025)';
        $this->data['heading'] = 'Master Entry - Rural Roads(2025)';
    ...
    //     // Get the existing file path from DB before upload
    //     $oldFile = $this->db->select('survey_estimated_doc')
    //         ->from('roads')
    //         ->where('id', $id)
    //         ->get()
    //         ->row();
    ...
    //     if ($oldFile && !empty($oldFile->survey_estimated_doc)) {
    //         $oldFilePath = FCPATH . $oldFile->survey_estimated_doc;
