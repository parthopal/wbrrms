        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('roads/rpt_road_type_progress'); ?>
                        <div class="row">
                            <div class="col-md-4">
    ...
    $(document).ready(function() {
        ...
        $('#tbl').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'rural_roads(2025)_road_type_progress_report_' + $.now(),
                    title: 'RURAL ROADS(2025) ROAD TYPE WISE PROGRESS REPORT ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/' +
