            ...
            <div class="col-md-12">
                <div class="card full-height">
                    <div id="view" class="card-body">
                        <?php echo form_open('srrp/rpt_update_summary'); ?>
                        <div class="row">
                            <div class="col-md-3">
    ...
    $(document).ready(function () {
        ...
        $('#tbl').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'pathashree-III_update_statu_report_' + $.now(),
                    title: 'PATHASHREE-III UPDATE STATUS REPORT OF PATHASHREE ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
