                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row ml-1">
                            ...
                            <button type="button" class="btn btn btn-icon btn-round btn-danger pointer" style="display: <?= ($role_id > 3 ? 'none' : '') ?>" data-toggle="tooltip" data-placement="top" title="Reset" onclick="wo_remove(<?= $selected->roads_id ?>)">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('roads/wo_save'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text"
                                            ...
                                            value="<?= isset($selected->wo_no) ? strtoupper($selected->wo_no) : '' ?>"
                                            autocomplete="off"
                                            required <?= $disabled ?>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type='text' id="pan_no" name="pan_no" class="form-control" placeholder="PAN no of Contractor" value="<?= isset($selected->pan_no) ? strtoupper($selected->pan_no) : '' ?>" autocomplete="off" required <?= $disabled ?> oninput="this.value=this.value.toUpperCase()">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type='number' id="awarded_cost" name="awarded_cost" class="form-control number" placeholder="Awarded Cost" value="<?= $selected->awarded_cost ?>" autocomplete="off" step="0.01" required <?= $disabled ?> oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                        <div class="input-group-prepend">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type='text' id="ps_cost" name="ps_cost" class="form-control" placeholder="Secuirity deposit" step="0.01" value="<?= $selected->ps_cost ?>" <?= $disabled ?> oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">INR</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type='number' id="additional_ps_cost" name="additional_ps_cost" class="form-control number" placeholder="Additional P.S." step="0.01" value="<?= $selected->additional_ps_cost ?>" <?= $disabled ?> oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">INR</span>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group d-flex justify-content-between align-items-center">
                                    <label class="mb-0">
                                        Upload Work Order Pdf *<br>
                                        <span style="font-size: 10px; color: red;">
                                            ( Maximum 2MB, Uploaded Format - .pdf )
                                        </span>
                                    </label>

                                    <?php if (isset($selected) && !empty($selected->document)) : ?>
                                        <a href="<?= '../../' . htmlspecialchars($selected->document); ?>"
                                            target="_blank"
                                    ...
                                    <div class="form-group">
                                        <div class="multiselect_div">
                                            <input type="file"
                                                ...
                                                data-default-file="<?= isset($selected) && !empty($selected->document) ? '../../' . htmlspecialchars($selected->document) : ''; ?>"
                                                <?= (isset($selected) && !empty($selected->document)) ? '' : 'required'; ?>
                    ...
                    <input type="hidden" id="roads_id" name="roads_id" value="<?= $selected->roads_id ?>">
                    <?php echo form_close(); ?>
                </div>
            </div>
        </div>
