                                        ...
                                        <div class="row">
                                            <div class="col-12 col-stats">
                                                <div class="numbers">
                                                    ...
                                                    <h4 class="card-title fw-bold"><?= $dashboard_count['approved_length'] ?? 0 ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-stats">
                                                <div class="numbers">
                                                    ...
                                                    <h4 class="card-title fw-bold"><?= round($dashboard_count['vetted_estimated_cost_incl_contingency'] / 10000000, 2 ?? 0) ?></h4>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-stats">
                                                <div class="numbers">
                                                    ...
                                                    <h4 class="card-title fw-bold"><?= $dashboard_count['tender_matured_length'] ?? 0 ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-stats">
                                                <div class="numbers">
                                                    ...
                                                    <h4 class="card-title fw-bold"><?= round($dashboard_count['tender_matured_cost'] / 10000000, 2) ?? 0 ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
