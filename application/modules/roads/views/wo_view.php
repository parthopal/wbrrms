                            ...
                            <table id="tbl" class="display table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    foreach ($wo as $row) {
                                        ...
                                        echo '<td>' . $document . '</td>';
                                        echo '<td><p style="margin:0px; width: 80px"><button class="btn btn-icon btn-round btn-sm btn-primary" onclick="wo_add(' . $row->roads_id . ')"  title="Edit"><i class="fas fa-pen pointer"></i></button></p>
                                         </td>';
                                        echo '</tr>';
                                        $i++;
                                    }
            ...
            buttons: [
                {
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'pathashree-III_wo_' + $.now(),
                    title: 'PATHASHREE-III WORK ORDER ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'PATHASHREE-III WORK ORDER',
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
