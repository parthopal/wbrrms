        ...
        <div class="row mt--2">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <?php echo form_open_multipart('roads/survey_save'); ?>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 mx-auto" id="pdf_section">
                                <div class="form-group d-flex justify-content-between align-items-center">
                                    <label class="mb-0">
                                        Vetted Estimated Report Upload *<br>
                                        <span style="font-size: 10px; color: red;">
                                            ( Maximum 5MB, Uploaded Format - .pdf )
                                        </span>
                                    </label>

                                    <?php if (isset($selected) && !empty($selected->survey_estimated_doc)) : ?>
                                        <a href="<?= '../../' . htmlspecialchars($selected->survey_estimated_doc); ?>"
                                            target="_blank"
                                    ...
                                    <div class="form-group">
                                        <div class="multiselect_div">
                                            <input type="file"
                                                ...
                                                data-default-file="<?= isset($selected) && !empty($selected->survey_estimated_doc) ? '../../' . htmlspecialchars($selected->survey_estimated_doc) : ''; ?>"
                                                <?= (isset($selected) && !empty($selected->survey_estimated_doc)) ? '' : 'required'; ?>>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    $(document).ready(function() {
        function togglePDFSection() {
            ...
            if (status == '2') { // Completed
                $('#pdf_section').show();
                $('input[name="userfile"]').attr('required', true);
            } else { // Not Started or Ongoing
                $('#pdf_section').hide();
