        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('roads/rpt_work_type_progress'); ?>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <tbody>
                                    ...
                                    if (sizeof($list) > 0) {
                                        ...
                                        foreach ($list as $row) {
                                            ...
                                            echo '<td>' . round($row->completed_length, 3) . '</td>';
            ...
            buttons: [
                {
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'rural_roads(2025)_work_type_progress_report_' + $.now(),
                    title: 'RURAL ROADS (2025) WORK TYPE WISE PROGRESS REPORT ON' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
