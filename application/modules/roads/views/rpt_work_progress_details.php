                                ...
                                <tbody>
                                    ...
                                    if (sizeof($list) > 0) {
                                        ...
                                        foreach ($list as $row) {
                                            ...
                                            $image1 = strlen($row->image1) > 0 ? '<div class="avatar"><a href="' . base_url($row->image1) . '" target="_blank"><img src="' . base_url($row->image1) . '" class="avatar-img rounded-circle"></a></div>' : '<div class="avatar"><img src="' . base_url('templates/img/no_img.jpg') . '" class="avatar-img rounded-circle"></div>';
    ...
    $(document).ready(function() {
        $('#tbl').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'rural_roads(2025)_work_progress_details_report_' + $.now(),
                    title: 'Rural Roads(2025) WORK PROGRESS DETAILS REPORT',
                    footer: true,
                    exportOptions: {
