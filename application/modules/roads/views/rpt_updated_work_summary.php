        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('roads/rpt_updated_work_summary'); ?>
                        <div class="row">
                            <div class="col-md-3">
    ...
    $(document).ready(function() {
        ...
        $('#tbl').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'rural_roads(2025)_updated_works_summary_report_' + $.now(),
                    title: 'RURAL ROADS(2025) REPORT ON UPDATED WORK SUMMARY ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/' +
