...
class SSM extends MX_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('ssm_model', 'model');
    ...
    function overview()
    {
        ...
        if ($session['role_id'] < 10) {
            $this->session->set_userdata('menu', 87);
        }
        ...
        $this->data['title'] = 'Pathashree-III';
        $this->data['heading'] = 'Overview - Pathashree-III';
    ...
    function index()
    {
        ...
        $this->data['title'] = 'Pathashree-III';
        $this->data['heading'] = 'Master - Pathashree-III';
        $this->data['subheading'] = 'Pathashree-III';
    ...
    function entry($id = 0)
    {
        ...
        $this->data['title'] = 'Pathashree-III';
        $this->data['heading'] = 'Master Entry - Pathashree-III';
    ...
    function survey()
    {
        ...
        $this->data['heading'] = 'Scheme Inbox - Pathashree-III'; //'Pending Survey';
    ...
    function survey_entry($id)
    {
        ...
        $this->data['selected'] = json_encode($selected);
        $this->data['title'] = 'Survey';
        $this->data['heading'] = 'Survey - Pathashree-III';
    ...
    function lot()
    {
        ...
        $this->data['heading'] = 'Batch/Lot Inbox - Pathashree-III'; // 'Scheme';
    ...
    function approval()
    {
        ...
        $this->data['title'] = 'Survey';
        $this->data['heading'] = 'Vetted Scheme Inbox - Pathashree-III'; // 'Approval';
        $this->data['subheading'] = 'Scheme Details';
        $this->data['selected'] = json_encode($selected);
    ...
    function admin_approval()
    {
        ...
        if (!$this->upload->do_upload('userfile')) {
            ...
            foreach ($result as $row) {
                $scheme_no++;
                $ref_no = str_pad($scheme_no, 5, '0', STR_PAD_LEFT) . '/' . $row->agency . '/' . $row->district . '/RASTASHREE3/2024';
                $input = array(
                    'scheme_no' => $scheme_no,
                    'ref_no' => $ref_no
                );
    ...
    function approved()
    {
        ...
        $this->data['title'] = 'Scheme';
        $this->data['heading'] = 'Approved Scheme Inbox - Pathashree-III';
        $this->data['subheading'] = 'Scheme Details';
        $this->data['selected'] = json_encode($selected);
    ...
    function print_lot($district_id, $lotno)
    {
        ...
        $this->data['heading'] = 'Print Lot - Pathashree-III';
    ...
    function not_traceable($id)
    {
        ...
        $this->data['heading'] = 'Scheme Not Implemented - Pathashree-III';
    ...
    function not_traceable_save()
    {
        ...
        if ($this->model->not_traceable_save($data)) {
            ...
            $session['role_id'] < 3 ? redirect('ssm') : redirect('ssm/survey');
        } else {
    ...
    function scheme_not_implemented()
    {
        ...
        $this->data['title'] = 'Scheme Not Implemented';
        $this->data['heading'] = 'Not Implemented List - Pathashree-III';
        $this->data['subheading'] = 'Scheme Not Implemented';
        $this->data['selected'] = json_encode($selected);
    ...
    function tender()
    {
        ...
        $this->data['heading'] = 'Tender - Pathashree-III';
    ...
    function tender_benefitted_save()
    {
        ...
        if ($this->model->tender_benefitted_save($data)) {
            $this->session->set_flashdata('message', array('type' => 'success', 'message' => 'Tender Save successfully'));
            redirect('ssm/tender_entry/' . $data['id']);
        } else {
            $this->session->set_flashdata('message', array('type' => 'warning', 'message' => 'can\'t save now, please try again later'));
            // echo '<script>alert("cannot be saved now, please try again later");</script>';
        }
    ...
    function wo()
    {
        ...
        $this->data['heading'] = 'Work Order - Pathashree-III';
    ...
    function wp($status = 0)
    {
        ...
        if ($session['role_id'] == 20) {
            ...
            $this->data['heading'] = 'Work Progress List - Pathashree-III';
    ...
    function wp_entry($id, $status)
    {
        ...
        $this->data['role_id'] = $session['role_id'];
        $this->data['status'] = $status;
        $this->data['heading'] = 'Work Progress Entry - Pathashree-III';
        $this->data['subheading'] = $status == 0 ? 'Not-Started' : ($status == 5 ? 'Completed' : 'Work-In-Progress');
    ...
    function wp_save()
    {
        ...
        redirect(base_url('ssm/wp/' . $input['status']));
    }

    function wp_upload($id, $ssm_id)
    {
        $path = 'uploads/ssm/progress/';
        if (!file_exists('./' . $path)) {
            mkdir('./' . $path, 0777, true);
        }
        $config['upload_path'] = './' . $path;
    ...
    function qm()
    {
        ...
        $this->data['selected'] = json_encode($selected);
        $this->data['heading'] = 'Quality Monitoring - Pathashree-III';
    ...
    function qm_details($id)
    {
        ...
        $this->data['heading'] = 'Assignment Details - Pathashree-III';
    ...
    function qm_inspection()
    {
        ...
        $this->data['sqm'] = json_encode($sqm_list);
        $this->data['selected'] = json_encode($selected);
        $this->data['heading'] = 'SQM Inspection - Pathashree-III';
    ...
    function qm_start($id)
    {
        if ($id > 0) {
            ...
            $this->data['heading'] = 'Inspection Images - Pathashree-III';
    ...
    function qm_submit($id)
    {
        if ($id > 0) {
            ...
            $this->data['heading'] = 'Overall Quality Grading Report - Pathashree-III';
    ...
    function qm_atr()
    {
        ...
        $this->data['list'] = json_encode($list);
        $this->data['selected'] = json_encode($selected);
        $this->data['heading'] = 'Action Taken Report - Pathashree-III';
    ...
    function qm_inspection_report()
    {
        ...
        $this->data['sqm'] = json_encode($sqm_list);
        $this->data['selected'] = json_encode($selected);
        $this->data['heading'] = 'Inspection Report - Pathashree-III';
    ...
    function qm_inspection_report_view($id)
    {
        if ($id > 0) {
            ...
            $this->data['heading'] = 'Inspection Report View - Pathashree-III';
    ...
    function report()
    {
        $this->data['heading'] = 'Report Overview - Pathashree-III';
        $this->data['subheading'] = 'pathashree-III schemes';
        $this->data['title'] = 'Pathashree-III';
    ...
    function rpt_state_summary()
    {
        ...
        $this->data['heading'] = 'State Summary Report - Pathashree-III';
        $this->data['subheading'] = 'pathashree-III schemes';
        $this->data['title'] = 'Pathashree-III';
    ...
    function rpt_agency_progress()
    {
        ...
        $this->data['heading'] = 'Agency wise Progress - Pathashree-III';
        $this->data['subheading'] = 'pathashree-III schemes';
        $this->data['title'] = 'Pathashree-III';
    ...
    function rpt_road_type_progress()
    {
        ...
        $this->data['list'] = json_encode($list);
        $this->data['selected'] = json_encode($selected);
        $this->data['heading'] = 'Road Type wise Progress - Pathashree-III';
        $this->data['subheading'] = 'pathashree-III schemes';
        $this->data['title'] = 'Pathashree-III';
    ...
    function rpt_work_type_progress()
    {
        ...
        $this->data['list'] = json_encode($list);
        $this->data['selected'] = json_encode($selected);
        $this->data['heading'] = 'Work Type wise Progress - Pathashree-III';
        $this->data['subheading'] = 'pathashree-III schemes';
        $this->data['title'] = 'Pathashree-III';
    ...
    function rpt_ps_work_status()
    {
        ...
        $this->data['selected'] = json_encode($selected);
        $this->data['list'] = json_encode($list);
        $this->data['heading'] = 'PS wise Work Status Report - Pathashree-III';
        $this->data['subheading'] = 'pathashree-III schemes';
        $this->data['title'] = 'Pathashree-III';
    ...
    function rpt_work_progress()
    {
        ...
        $this->data['selected'] = json_encode($selected);
        $this->data['list'] = json_encode($list);
        $this->data['heading'] = 'Work wise Progress Report - Pathashree-III';
        $this->data['subheading'] = 'pathashree-III schemes';
        $this->data['title'] = 'Pathashree-III';
    ...
    function rpt_work_progress_details($ssm_id)
    {
        ...
        $this->data['heading'] = 'Work Progress Details Report - Pathashree-III';
    ...
    function rpt_qm_summary()
    {
        ...
        $this->data['district'] = json_encode($district_list);
        $this->data['heading'] = 'Quality Monitoring Report - Pathashree-III';
        $this->data['subheading'] = 'pathashree-III schemes';
        $this->data['title'] = 'Pathashree-III';
    ...
    function update()
    {
        ...
        $this->data['selected'] = json_encode($selected);
        $this->data['list'] = json_encode($list);
        $this->data['heading'] = 'Update of Pathashree Schemes - Pathashree-III';
        $this->data['subheading'] = 'pathashree-III schemes';
        $this->data['title'] = 'Pathashree-III';
    ...
    function rpt_update_summary()
    {
        ...
        $this->data['selected'] = json_encode($selected);
        $this->data['list'] = json_encode($list);
        $this->data['heading'] = 'Update Summary Report - Pathashree-III';
        $this->data['subheading'] = 'pathashree-III schemes';
        $this->data['title'] = 'Pathashree-III';
    ...
    function rpt_approval_progress()
    {
        ...
        $this->data['heading'] = 'Approval Progress - Pathashree-III';
        $this->data['subheading'] = 'pathashree-III schemes';
        $this->data['title'] = 'Pathashree-III';
