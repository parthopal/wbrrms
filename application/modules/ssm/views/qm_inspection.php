        ...
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                ...
                <div class="ml-md-auto py-2 py-md-0">
                    <a href="<?= base_url('ssm/qm_inspection_report') ?>" class="btn btn-secondary btn-round">Report</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('ssm/qm_inspection'); ?>
                        <div class="row">
                            <div class="col-md-6">
...
<script>
    ...
    function start(id) {
        window.location.href = baseURL + "/ssm/qm_start/" + id;
    }
    function submit(id) {
        window.location.href = baseURL + "/ssm/qm_submit/" + id;
    } 
</script>