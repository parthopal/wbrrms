...
$ac = json_decode($ac);
// $road_type = json_decode($road_type);
?>
<div class="container">
        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('ssm/rpt_road_type_progress'); ?>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Road Type</label>
                                    <select id="road_type" name="road_type" class="form-control dropdown">                                      
                                        <option value=""<?= $selected->road_type == '' ? 'selected' : ''?>>--All road type--</option>
            ...
            buttons: [
                {
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'pathashree-III_road_type_progress_report_' + $.now(),
                    title: 'PATHASHREE-III ROAD TYPE WISE PROGRESS REPORT ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'PATHASHREE-III ROAD TYPE WISE PROGRESS REPORT',
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
