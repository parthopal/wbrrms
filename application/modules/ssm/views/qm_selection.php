            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <?php echo form_open_multipart('ssm/save_atr'); ?>
                        ...
                        <div class="col-md-8">
                            ...
                            <label for="test_conducted">Reject With Reason</label>
                                <textarea class="form-control" name="test_conducted" id="test_conducted" rows="4" cols="50"></textarea>
                            </div>
                        </div>
                        </div>
                        <div class="row">
