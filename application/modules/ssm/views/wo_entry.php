                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row ml-1">
                            ...
                            <button type="button" class="btn btn btn-icon btn-round btn-danger pointer" style="display: <?= ($role_id > 3 ? 'none' : '') ?>" data-toggle="tooltip" data-placement="top" title="Reset" onclick="wo_remove(<?= $selected->ssm_id ?>)">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('ssm/wo_save'); ?>
                    ...
                    <input type="hidden" id="ssm_id" name="ssm_id" value="<?= $selected->ssm_id ?>">
                    <?php echo form_close(); ?>
                </div>
            </div>
        </div>
