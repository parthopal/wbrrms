        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('ssm/rpt_work_type_progress'); ?>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Work Type</label>
                                    <select id="work_type" name="work_type" class="form-control dropdown">
                                        <option value=""<?= $selected->work_type == '' ? 'selected' : ''?>>--All work type--</option>
            ...
            buttons: [
                {
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'pathashree-III_work_type_progress_report_' + $.now(),
                    title: 'PATHASHREE-III WORK TYPE WISE PROGRESS REPORT ON' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'PATHASHREE-III WORK TYPE WISE PROGRESS REPORT',
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
