        ...
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                ...
                <div id="div_sync" class="ml-md-auto py-2 py-md-0" style="display: none;">
                    <a href="<?= base_url('common/ssm_report') ?>" class="btn btn-primary btn-round">Sync1</a>
                    <a href="<?= base_url('common/update_ssm_report') ?>" class="btn btn-secondary btn-round">Sync2</a>
                    <a href="<?= base_url('common/update_ssm_report_daily') ?>" class="btn btn-danger btn-round">Sync3</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <a href="<?= base_url('ssm/rpt_state_summary') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('ssm/rpt_agency_progress') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('ssm/rpt_road_type_progress') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('ssm/rpt_work_type_progress') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('ssm/rpt_ps_work_status') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('ssm/rpt_work_progress') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('ssm/rpt_approval_progress') ?>">
                                    <div class="card card-stats card-secondary card-round">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12 col-stats">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('ssm/rpt_updated_work_summary') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('ssm/rpt_updated_work_details') ?>">
							...
							<div class="col-md-4" id="document_report" style="display: none;">
                                <a href="<?= base_url('ssm/rpt_all_documnets') ?>">
