                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2 mt-4 text-right">
                                <div class="form-group">
                                    <button type="submit" id="search_bridge_wo" name="search_bridge_wo" class="btn btn-primary">
                            ...
                            <table id="tbl" class="display table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    foreach ($wo as $row) {
                                        ...
                                        echo '<td><p style="margin:0px; width: 80px"><button class="btn btn-icon btn-round btn-sm btn-primary" onclick="wo_add(' . $row->capex_bridge_id . ')"  title="Edit" ' . $disabled . '><i class="fas fa-pen pointer"></i></button></p></td>';
                                        echo '</tr>';
                                        $i++;
                                    }
                                    ?>
    ...
    $(document).ready(function () {
        ...
        $('#tbl').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'capex_bridge_wo_' + $.now(),
                    title: 'CAPEX BRIDGE WORK ORDER ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/' +
