                                ...
                                <tbody>
                                    ...
                                    if ($wp != null) {
                                        ...
                                        foreach ($wp as $row) {
                                            ...
                                            echo '<td>
                                                    <a href="' . base_url('capex/wp_image_view/' . $row->id) . '" 
                                                    target="_blank" 
                                                    class="btn btn-md btn-icon btn-round btn-primary" 
                                                    title="Progress Images">
                                                        <i class="fa fa-image" style="font-size: 25px;color: white;margin-top: 6px;"></i>
                                                    </a>
                                                </td>';
...
<script>
    function entry(id, status) {
        window.open(baseURL + '/capex/wp_entry/' + id + '/' + status, '_self');
    }
</script>