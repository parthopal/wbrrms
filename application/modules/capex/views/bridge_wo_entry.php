                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row ml-1">
                            ...
                            <button type="button" class="btn btn btn-icon btn-round btn-danger pointer" style="display: <?= ($role_id > 3 ? 'none' : '') ?>" data-toggle="tooltip" data-placement="top" title="Reset" onclick="wo_remove(<?= $selected->capex_bridge_id ?>)">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('capex/bridge_wo_save'); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Awarded Cost * <span class="small text-danger"> (Full Amount e.g. 00,00,000)</span></label>
                                    <div class="input-group mb-3">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="multiselect_div">
                                            <input type="file" name="userfile" class="dropify" accept="application/pdf" data-max-file-size="2M" data-default-file="<?= isset($selected) && !empty($selected->document) ? '../../' . htmlspecialchars($selected->document) : ''; ?>"
                    ...
                    <input type="hidden" id="capex_bridge_id" name="capex_bridge_id" value="<?= $selected->capex_bridge_id ?>">
                    <?php echo form_close(); ?>
                </div>
            </div>
        </div>
...
<script>
    ...
    //         },
    //         error: {
    //             'fileSize': 'The file size is too big (2 MB max).',
