...
$url = base_url('capex/bridge_qm_entry');
            ...
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <?php echo form_open('capex/bridge_qm'); ?>
                        <div class="row">
                            <div class="col-md-3">
...
<script>
        ...
        $('#tbl').DataTable({
            ...
            buttons: [{
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'CAPEX BRIDGE QM-WISE REPORT',
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
    ...
    function details(id) {
        window.open(baseURL + "/capex/bridge_qm_report_view/" + id, '_blank');
    }

    function start(id) {
        // console.log(id);
        window.location.href = baseURL + "/capex/bridge_qm_start/" + id;
    }

    function submit(id) {
        window.location.href = baseURL + "/capex/bridge_qm_submit/" + id;
    }
</script>
