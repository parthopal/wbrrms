        ...
        <div class="row mt--2">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <?php echo form_open('capex/bridge_tender_save'); ?>
                    <div class="card-body">
                        <div class="row">
                            <div id="div_tender" class="col-md-12">
                                <div class="card card-dark bg-secondary-gradient pointer">
                                    <div class="card-body skew-shadow">
                                        <p><span style="color: yellow;"><?= $selected->district . ' / ' . $selected->block ?></span></p>
                                        ...
                                        <div class="row">
                                            <div class="col-10 pl-0 text-right">
                                                ...
                                                <div class="text-small text-uppercase fw-bold op-8">Scheme No : <?= $selected->scheme_id . ' / ' . $selected->district . ' / ' . $selected->block ?></div>
                                            </div>
