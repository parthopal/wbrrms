                            ...
                            <table id="tbl" class="display table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    foreach ($wo as $row) {
                                        ...
                                        echo '<td>' . $document . '</td>';
                                        echo '<td><p style="margin:0px; width: 80px"><button class="btn btn-icon btn-round btn-sm btn-primary" onclick="wo_add(' . $row->capex_id . ')"  title="Edit"><i class="fas fa-pen pointer"></i></button></p>
                                         </td>';
                                        echo '</tr>';
                                        $i++;
                                    }
