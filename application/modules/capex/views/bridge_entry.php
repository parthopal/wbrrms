            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-1">
                                <a href="<?= base_url('capex/bridge_view') ?>">
                        ...
                        <hr>
                        <?php echo form_open('capex/bridge_save'); ?>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="scheme_id" name="scheme_id" class="form-control" placeholder="Scheme ID" value="<?= $selected->scheme_id ?>" autocomplete="off" <?= $readonly ?> required style="text-transform: uppercase;" pattern="[A-Z0-9]+" oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9]/g, '');">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="type_id" name="type_id" class="form-control dropdown" <?= $disabled ?> required>
                                        <?php
                                        foreach ($type as $row) {
                                            if ($row->id == 2) {
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="length" name="length" class="form-control" value="<?= $selected->length ?>" autocomplete="off" <?= $readonly ?> required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="sanctioned_cost" name="sanctioned_cost" class="form-control" placeholder="Sanctioned Cost" value="<?= $selected->sanctioned_cost ?>" autocomplete="off" <?= $readonly ?> oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="admin_no" name="admin_no" class="form-control number" placeholder="Admin No." value="<?= $selected->admin_no ?>" autocomplete="off" <?= $readonly ?> required style="text-transform: uppercase;" pattern="[A-Z0-9]+" oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9]/g, '');">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
