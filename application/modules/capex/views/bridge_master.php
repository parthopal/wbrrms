                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2 text-right" <?= $visible ?>>
                                <a href="<?= base_url('capex/bridge_entry') ?>" class="btn btn-success btn-round">Add</a>
                            </div>
                        </div>
                        <hr>
                        <?php echo form_open('capex/bridge_view'); ?>
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <table id="tbl" class="display table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($list as $row) {
                                            ...
                                            } else if ($row->isactive == 1 && $row->survey_status == 6) {
