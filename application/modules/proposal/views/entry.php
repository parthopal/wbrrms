            ...
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Referred By (Name & Designation)</label>
					    ...
					    <option value="" <?= $selected->letter == '' ? 'selected' : '' ?>>--Select Type--</option>
						...
						<option value="whatsapp" <?= $selected->letter = 'whatsapp' ? 'selected' : '' ?>>WhatsApp</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
