        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('srrp/rpt_ps_work_status'); ?>
                        <div class="row">
            ...
            buttons: [
                {
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'pathashree-II_ps_work_status_report_' + $.now(),
                    title: 'PATHASHREE-II PS WISE WORK STATUS REPORT ON' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'PATHASHREE-II PS WISE WORK STATUS REPORT',
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
