        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('srrp/rpt_updated_work_details'); ?>
                        <div class="row">
                            <div class="col-md-3">
    ...
    $(document).ready(function() {
        ...
        $('#tbl').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'pathashree-II_updated_work_details_report_' + $.now(),
                    title: 'PATHASHREE-II REPORT ON UPDATED WORK DETAILS ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/' +
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'PATHASHREE-II REPORT ON UPDATED WORK DETAILS',
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
