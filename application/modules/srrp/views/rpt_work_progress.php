        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('srrp/rpt_work_progress'); ?>
                        <div class="row">
                                ...
                                <tbody>
                                    ...
                                    if (sizeof($list) > 0) {
                                        ...
                                        foreach ($list as $row) {
                                            ...
                                            $name = $row->pp_status > 0 ? '<a href="' . base_url('srrp/rpt_work_progress_details/' . $row->id) . '" target="_blank">' . $name . '</a>' : $name;
                                            echo '<td>' . $name . '</td>';
    ...
    $(document).ready(function () {
        ...
        $('#tbl').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'pathashree-II_work_progress_report_' + $.now(),
                    title: 'PATHASHREE-II WORK-WISE PROGRESS ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'PATHASHREE-II WORK-WISE PROGRESS',
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
