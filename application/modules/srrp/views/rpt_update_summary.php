    ...
    $(document).ready(function () {
        ...
        $('#tbl').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'pathashree_update_statu_report_' + $.now(),
                    title: 'UPDATE STATUS REPORT OF PATHASHREE ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
