            ...
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <hr>
                        <?php echo form_open('srrp/qm_entry'); ?>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="sqm_id" name="sqm_id" class="form-control dropdown">
                                        ...
                                        foreach ($sqm as $row) {
                                            $_selected = ($selected->sqm_id > 0 && $selected->sqm_id == $row->id) ? 'selected' : '';
    ...
    <div class="page-inner mt--5">
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('srrp/qm_save'); ?>
                                ...
                                <tbody>
                                    ...
                                    if (sizeof($scheme) > 0) {
                                        foreach ($scheme as $row) {
                                            ...
                                            echo '<td>' . ($row->atr_action == 0 ? 'Verification' : ($row->atr_action == 1 ? 'Accepted' : 'Reject')) . '</td>';
