            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <a href="<?= base_url('srrp/rpt_state_summary') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('srrp/rpt_agency_progress') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('srrp/rpt_road_type_progress') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('srrp/rpt_work_type_progress') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('srrp/rpt_ps_work_status') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('srrp/rpt_work_progress') ?>">
                            ...
                            <div class="col-md-4" style="display: none;">
                                <a href="<?= base_url('srrp/rpt_update_summary') ?>">
                                    <div class="card card-stats card-primary card-round">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12 col-stats">
                                                    <div class="numbers">
                                                        <p class="card-category">Update Summary Report</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('srrp/rpt_updated_work_summary') ?>">
                            ...
                            <div class="col-md-4">
                                <a href="<?= base_url('srrp/rpt_updated_work_details') ?>">
