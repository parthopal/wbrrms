...
$wp = $wp == '' ? '' : json_decode($wp); //var_dump($wp); exit;
?>
<div class="container">
        ...
        <div class="row mt--2">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('srrp/wp_save'); ?>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type='number' id="wp_progress" name="wp_progress" class="form-control number" placeholder="progress percentage" max="100" value="<?= $wp->physical_progress ?>" min="<?= $wp->physical_progress ?>" step="1" required>
