...
class SRRP extends MX_Controller {
    ...
    function survey() {
        ...
        $this->data['heading'] = 'Scheme Inbox'; //'Pending Survey';
    ...
    function lot() {
        ...
        $this->data['heading'] = 'Batch/Lot Inbox'; // 'Scheme';
        $this->data['subheading'] = 'Scheme Details';
        $this->data['selected'] = json_encode($selected);
    ...
    function approval() {
        ...
        $this->data['title'] = 'Survey';
        $this->data['heading'] = 'Vetted Scheme Inbox'; // 'Approval';
        $this->data['subheading'] = 'Scheme Details';
        $this->data['selected'] = json_encode($selected);
    ...
    function scheme_not_implemented() {
        ...
        $this->data['title'] = 'Scheme Not Implemented';
        $this->data['heading'] = 'Not Implemented List';
        $this->data['subheading'] = 'Scheme Not Implemented';
        $this->data['selected'] = json_encode($selected);
    ...
    function wp($status = 0) {
        ...
        if ($session['role_id'] == 20) {
            ...
            $this->data['heading'] = 'Work Progress List';
    ...
    function wp_entry($id, $status) {
        ...
        $this->data['status'] = $status;
        $this->data['heading'] = 'Work Progress Entry';
        $this->data['subheading'] = $status == 0 ? 'Not-Started' : ($status == 5 ? 'Completed' : 'Work-In-Progress');
...
################################## QM ##########################################
    ...
    function qm() {
        ...
        $this->data['district_id'] = $session['district_id'];
        $this->data['list'] = json_encode($list);
        $this->data['selected'] = json_encode($selected);
        $this->data['heading'] = 'Quality Monitoring';
    ...
    function qm_entry() {
       ...
       // var_dump($selected);exit;
        ...
        $district_list = $this->common->get_district_list();
       // var_dump($district_list);exit;
        $sqm_list = $this->model->get_sqm_list();
        //var_dump($sqm_list);exit;
    ...
    function qm_inspection() {
        ...
        $this->data['sqm'] = json_encode($sqm_list);
        $this->data['selected'] = json_encode($selected);
        $this->data['heading'] = 'SQM Inspection';
    ...
    function qm_start($id) {
        if ($id > 0) {
            ...
            $this->data['heading'] = 'Inspection Images';
    ...
    function qm_inspection_report() {
        ...
        $this->data['sqm'] = json_encode($sqm_list);
        $this->data['selected'] = json_encode($selected);
        $this->data['heading'] = 'Inspection Report';
    ...
    function qm_inspection_report_view($id) {
        if ($id > 0) {
            ...
            $this->data['heading'] = 'Inspection Report View';
...
################################# REPORT #######################################
    ...
    function rpt_state_summary() {
        ...
        $this->data['heading'] = 'State Summary Report';
        $this->data['subheading'] = 'pathashree-rastashree schemes';
        $this->data['title'] = 'PATHASHREE-RASTASHREE';
    ...
    function rpt_agency_progress() {
        $this->data['list'] = json_encode($this->model->get_rpt_agency_progress());
    ...
    function rpt_road_type_progress() {
        ...
        $list = $this->model->get_rpt_road_type_progress($selected['road_type']);
        $this->data['list'] = json_encode($list);
        $this->data['selected'] = json_encode($selected);
        $this->data['heading'] = 'Road Type wise Progress';
        $this->data['subheading'] = 'pathashree-rastashree schemes';
        $this->data['title'] = 'PATHASHREE-RASTASHREE';
    ...
    function rpt_work_type_progress() {
        ...
        $list = $this->model->get_rpt_work_type_progress($selected['work_type']);
        $this->data['list'] = json_encode($list);
        $this->data['selected'] = json_encode($selected);
        $this->data['heading'] = 'Work Type wise Progress';
        $this->data['subheading'] = 'pathashree-rastashree schemes';
        $this->data['title'] = 'PATHASHREE-RASTASHREE';
    ...
    function rpt_ps_work_status() {
        ...
        if ($this->input->post()) {
            ...
            if (sizeof($_post) > 0) {
                ...
                $block_list = $this->common->get_block_list($selected['district_id']);
                $list = $this->model->get_rpt_ps_work_status($selected['district_id'], $selected['block_id']);
            }
        }
        $district_list = $this->common->get_district_list();
        if (sizeof($district_list) == 1) {
        ...
        $this->data['selected'] = json_encode($selected);
        $this->data['list'] = json_encode($list);
        $this->data['heading'] = 'PS wise Work Status Report';
        $this->data['subheading'] = 'pathashree-rastashree schemes';
        $this->data['title'] = 'PATHASHREE-RASTASHREE';
    ...
    function rpt_work_progress() {
        ...
        if ($this->input->post()) {
            ...
            if (sizeof($_post) > 0) {
                ...
                $block_list = $this->common->get_block_list($selected['district_id']);
                $list = $this->model->get_rpt_work_progress($selected['district_id'], $selected['block_id'], $selected['wp_id']);
            }
        }
        $district_list = $this->common->get_district_list();
        if (sizeof($district_list) == 1) {
        ...
        $this->data['selected'] = json_encode($selected);
        $this->data['list'] = json_encode($list);
        $this->data['heading'] = 'Work wise Progress Report';
        $this->data['subheading'] = 'pathashree-rastashree schemes';
        $this->data['title'] = 'PATHASHREE-RASTASHREE';
    ...
    function rpt_work_progress_details($srrp_id) {
        ...
        $this->data['heading'] = 'Work Progress Details Report';
    ...
    function rpt_qm_summary() {
        ...
        $this->data['district'] = json_encode($district_list);
        $this->data['heading'] = 'Quality Monitoring Report';
        $this->data['subheading'] = 'pathashree-rastashree schemes';
        $this->data['title'] = 'PATHASHREE-RASTASHREE';
