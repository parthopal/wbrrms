...
class RIDF extends MX_Controller {
    ...
    function survey() {
        ...
        $this->data['heading'] = 'Scheme Inbox - RIDF'; //'Pending Survey';
    ...
    function lot() {
        ...
        $this->data['heading'] = 'Batch/Lot Inbox - RIDF'; // 'Scheme';
    ...
    function approval() {
        ...
        $this->data['title'] = 'Survey';
        $this->data['heading'] = 'Vetted Scheme Inbox - RIDF'; // 'Approval';
        $this->data['subheading'] = 'Scheme Details';
        $this->data['selected'] = json_encode($selected);
    ...
    function approved() {
        ...
        $this->data['title'] = 'Scheme';
        $this->data['heading'] = 'Approved Scheme Inbox - RIDF';
        $this->data['subheading'] = 'Scheme Details';
        $this->data['selected'] = json_encode($selected);
    ...
    function get_approved_list() {
        $data = $this->input->get();
        // print_r($data); exit;
        echo json_encode($this->model->get_approved_list($data['district_id'], $data['category_id'], $data['type_id']));
    }

    function print_lot($district_id, $lotno) {
        $this->data['title'] = 'Print';
        $this->data['heading'] = 'Print Lot - RIDF';
    ...
    function not_traceable($id) {
        ...
        $this->data['heading'] = 'Scheme Not Implemented - RIDF';
    ...
    function scheme_not_implemented() {
        ...
        $this->data['title'] = 'Scheme Not Implemented';
        $this->data['heading'] = 'Not Implemented List - RIDF';
        $this->data['subheading'] = 'Scheme Not Implemented';
        $this->data['selected'] = json_encode($selected);
    ...
    function delete_not_traceable($id) {
        ...
        redirect('ridfe/scheme_not_implemented');
    }
    ...
    function tender_entry($id) { //echo 'am here'; exit;
        $selected = array();
        if ($id > 0) {
    ...
    //         $this->session->set_flashdata('message', array('type' => 'success', 'message' => 'Tender Save successfully'));
    //         // redirect('ridf/tender_entry/' . $data['id']);
    //     } else {
    //         $this->session->set_flashdata('message', array('type' => 'warning', 'message' => 'can\'t save now, please try again later'));
    //         // echo '<script>alert("cannot be saved now, please try again later");</script>';
    //     }
...
################################# REPORT #######################################
    ...
    function update() {
        ...
        $this->data['selected'] = json_encode($selected);
        $this->data['list'] = json_encode($list);
        $this->data['heading'] = 'Update of Pathashree Schemes - RIDF';
        $this->data['subheading'] = 'RIDF schemes';
        $this->data['title'] = 'RIDF';
    ...
    function rpt_update_summary() {
        ...
        $this->data['selected'] = json_encode($selected);
        $this->data['list'] = json_encode($list);
        $this->data['heading'] = 'Update Summary Report - RIDF';
        $this->data['subheading'] = 'RIDF schemes';
        $this->data['title'] = 'RIDF';
    ...
    function rpt_approval_progress() {
        ...
        $this->data['heading'] = 'Approval Progress - RIDF';
        $this->data['subheading'] = 'RIDF schemes';
        $this->data['title'] = 'RIDF';
