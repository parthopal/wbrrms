...
<div class="container">
    ...
    <?php echo form_open('ridf/tender'); ?>
                            ...
                            <table id="tbl" class="display table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    foreach ($approved as $row) {
                                        ...
                                        if ($role_id != 12) {
                                            echo '<td><p style="margin:0px; width: 90px"><button data-toggle="tooltip" data-placement="bottom"  class="btn btn-icon btn-round btn-sm btn-primary" onclick="entry(' . $row->id . ',' . $row->tender_status . ')"  title="Edit"><i class="fas fa-pen pointer"></i></button></p>
                                                </td>';
                                        }
                                        echo '</tr>';
                                    }
...
<script>
function tender_entry(id, tender_status) {
        if (tender_status == 0) {
            tender_entry(id)
        // } else {
        //     $('#id').val(id);
            ...
            buttons: [
                {
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'RIDF_tender_' + $.now(),
                    title: 'RIDF TENDER ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
