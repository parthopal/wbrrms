            ...
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <hr>
                        <?php echo form_open('scheme/tender/' . $sc); ?>
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <table id="tbl" class="display table table-bordered table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Agency</th>
                                            <th>Length/No.</th>
                                            <th>Sanctioned Cost<br><small>(in lakh)</small></th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($list as $row) {
                                            ...
                                            echo '<td>' . $row->retender . '</td>';
                                            echo '<td><a href="' . base_url('scheme/tender_entry/' . $sc . '/' . $row->id) . '"><button class="btn btn-icon btn-round btn-sm btn-primary" title="Edit"><i class="fas fa-pen pointer"></i></button></a></td>';
                                            echo '</tr>';
                                            $i++;
                                        }
                                        ?>
