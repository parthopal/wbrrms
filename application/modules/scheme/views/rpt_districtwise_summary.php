        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                    <?php echo form_open('scheme/rpt_districtwise_summary/' . $sc); ?>
                        <div class="row">
                        <div class="col-md-3">
        ...
        $('#tbl').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    text: 'Print',
                    // title: 'STATE SUMMARY REPORT',
                    title: 'DISTICTWISE SUMMARY REPORT ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
