        ...
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                ...
                <div class="ml-md-auto py-2 py-md-0">
                    <a href="<?= base_url('scheme/view/' . $sc) ?>" class="btn btn-white btn-border btn-round mr-2">Scheme</a>
                    <a href="<?= base_url('scheme/tender/' . $sc) ?>" class="btn btn-secondary btn-round">Tender</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <hr>
                        <?php echo form_open('scheme/wo/' . $sc); ?>
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <table id="tbl" class="display table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($list as $row) {
                                            ...
                                            echo '<td>' . ROUND($row->sanction_cost / 100000, 2) . '</td>';
                                            echo '<td>No.: <b>' . $row->admin_no . '</b> on <b>' . date('d/m/Y', strtotime($row->admin_date)) . '</b></td>';
                                            echo '<td><a href="' . base_url('scheme/wo_entry/' . $sc . '/' . $row->id) . '"><button class="btn btn-icon btn-round btn-sm btn-primary" title="Edit"><i class="fas fa-pen pointer"></i></button></a></td>';
                                            echo '</tr>';
                                            $i++;
                                        }
                                        ?>
