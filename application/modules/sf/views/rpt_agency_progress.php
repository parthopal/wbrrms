        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('sf/rpt_agency_progress'); ?>
                        <div class="row">
                            <div class="col-md-4">
            ...
            buttons: [
                {
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'sfo_agency_progress_report_' + $.now(),
                    title: 'STATE FUND & OTHERS AGENCY-WISE PROGRESS REPORT (State Fund' + ($('#hdn_tag').val().length > 0 ? ' - ' + $('#hdn_tag').val() : '') + ') ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'STATE FUND & OTHERS AGENCY-WISE PROGRESS REPORT',
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
