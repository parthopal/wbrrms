        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('sf/rpt_work_progress'); ?>
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <tbody>
                                    ...
                                    if (sizeof($list) > 0) {
                                        ...
                                        foreach ($list as $row) {
                                            ...
                                            $name = $row->pp_status > 0 ? '<a href="' . base_url('sf/rpt_work_progress_details/' . $row->id) . '" target="_blank">' . $name . '</a>' : $name;
                                            echo '<td>' . $name . '</td>';
                                            ...
                                            echo '<td>' . $image3 . '</td>';
                                            echo '<td>'. $row->inspection_count . '</td>';
                                            echo '<td>' . date('d/m/Y',strtotime($row->last_work_date)) . '</td>';
                                            echo '</tr>';
                                        }
                                    }
                                    ?>
    ...
    $(document).ready(function () {
        ...
        $('#tbl').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'sfo_work_progress_report_' + $.now(),
                    title: 'STATE FUND & OTHERS WORK-WISE PROGRESS (State Fund' + ($('#hdn_tag').val().length > 0 ? ' - ' + $('#hdn_tag').val() : '') + ') ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'STATE FUND & OTHERS WORK-WISE PROGRESS',
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
