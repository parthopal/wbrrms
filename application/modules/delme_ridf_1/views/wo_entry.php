                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row ml-1">
                            ...
                            <button type="button" class="btn btn btn-icon btn-round btn-danger pointer" style="display: <?= ($role_id > 3 ? 'none' : '') ?>" data-toggle="tooltip" data-placement="top" title="Reset" onclick="wo_remove(<?= $selected->ridf_id ?>)">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('ridf/wo_save'); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="multiselect_div">
                                            <input type="file" name="userfile" class="dropify" accept="application/pdf" data-max-file-size="10000M" data-default-file="<?= isset($selected) && !empty($selected->document) ? '../../' . htmlspecialchars($selected->document) : ''; ?>"
                                                <?= isset($selected->document) && strlen($selected->document) > 0 ? 'required' : 'required'; ?>
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Mobile Number" name="mobile" value="<?= $selected->mobile ?>" class="form-control" required maxlength="10" title="Please enter a valid 10-digit mobile number">
                                    </div>
                                </div>
                    ...
                    <input type="hidden" id="ridf_id" name="ridf_id" value="<?= $selected->ridf_id ?>">
                    <?php echo form_close(); ?>
                </div>
            </div>
        </div>
