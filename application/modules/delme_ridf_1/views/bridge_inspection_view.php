...
$url = base_url('ridf/bridge_inspection_entry');
            ...
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <?php echo form_open('ridf/bridge_inspection'); ?>
                        <div class="row">
                            <div class="col-md-3">
...
<script>
    $(document).ready(function () {
        $('#tbl').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'RIDF Bridge_inspection_view_' + $.now(),
    ...
    function start(id) {
        console.log(id);
        window.location.href = baseURL + "/ridf/bridge_inspection_start/" + id;
    }

    function submit(id) {
        window.location.href = baseURL + "/ridf/bridge_inspection_submit/" + id;
    }

    function details(id) {
        window.open(baseURL + "/ridf/bridge_inspection_report_view/" + id, '_blank');
    }
</script>
