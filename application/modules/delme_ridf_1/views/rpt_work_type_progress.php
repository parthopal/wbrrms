        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('ridf/rpt_work_type_progress'); ?>
                        <div class="row">
                            <div class="col-md-4">
            ...
            buttons: [
                {
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'RIDF_work_type_progress_report_' + $.now(),
                    title: 'RIDF WORK TYPE WISE PROGRESS REPORT ON' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'RIDF WORK TYPE WISE PROGRESS REPORT',
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
