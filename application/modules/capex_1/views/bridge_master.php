        ...
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                ...
                <!-- <div class="ml-md-auto py-2 py-md-0">
                    <a href="<?= base_url('capex/tender') ?>" class="btn btn-white btn-border btn-round mr-2">Tender</a>
                    <a href="<?= base_url('capex/wo') ?>" class="btn btn-secondary btn-round">Work Order</a>
                </div> -->
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2 text-right" <?= $visible ?>>
                                <a href="<?= base_url('capex/bridge_entry/0') ?>" class="btn btn-success btn-round">Add</a>
                            </div>
                        </div>
                        <hr>
                        <?php echo form_open('capex/bridge_master'); ?>
                        <div class="row">
                            <div class="col-md-3">
    ...
    $(document).ready(function () {
        ...
        $('#tbl').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'capex_bridge_master_list_' + $.now(),
                    title: 'CAPEX BRIDGE MASTER LIST ON ' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/' +
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'CAPEX BRIDGE MASTER LIST ' + $.now(),
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
