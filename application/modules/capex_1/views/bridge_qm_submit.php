        ...
        <div class="row mt--2">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('capex/bridge_qm_save_submit'); ?>
                        <hr>
                        <div class="row">
                            <div class="col">
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            <label>Overall Grade <span style="color: red; font-size: 20px">*</span></label>
                                            <div class="input-group">
                                                <div class="form-check form-check-inline">
                                                    <label class="form-check-label" for="s"><input class="form-check-input" type="radio" name="overall_grade" id="s" value='s'>S</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <label class="form-check-label" for="u"><input class="form-check-input" type="radio" name="overall_grade" id="u" value='u'>U</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <label class="form-check-label" for="sri"><input class="form-check-input" type="radio" name="overall_grade" id="sri" value='sri'>SRI</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
