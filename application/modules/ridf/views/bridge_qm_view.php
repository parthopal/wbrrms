...
$url = base_url('ridf/bridge_qm_entry');
...
<script>
        ...
        $('#tbl').DataTable({
            ...
            buttons: [{
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'RIDF BRIDGE QM-WISE REPORT',
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
    ...
    function details(id) {
        window.open(baseURL + "/ridf/bridge_qm_report_view/" + id, '_blank');
    }

    function start(id) {
        // console.log(id);
        window.location.href = baseURL + "/ridf/bridge_qm_start/" + id;
    }

    function submit(id) {
        window.location.href = baseURL + "/ridf/bridge_qm_submit/" + id;
    }
</script>
