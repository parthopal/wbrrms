                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="year" id="year" class="form-control dropdown">
                                        ...
                                        <option value="2024" <?= $selected->year == '2025' ? 'selected' : '' ?>>2025</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-3">
...
<script>
    ...
    function details(id) {
        window.open(baseURL + "/ridf/qm_details/" + id, '_blank');
    }
</script>
