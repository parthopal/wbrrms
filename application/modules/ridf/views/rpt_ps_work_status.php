        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('ridf/rpt_ps_work_status'); ?>
                        <div class="row">
                            <div class="col-md-3">
            ...
            buttons: [
                {
                    extend: 'excel',
                    text: 'Excel',
                    filename: 'RIDF_ps_work_status_report_' + $.now(),
                    title: 'RIDF PS WISE WORK STATUS REPORT ON' + String(currentdate.getDate()).padStart(2, '0') + '/' + String((currentdate.getMonth() + 1)).padStart(2, '0') + '/'
                ...
                },
                {
                    extend: 'print',
                    text: 'Print',
                    title: 'RIDF PS WISE WORK STATUS REPORT',
                    footer: true,
                    exportOptions: {
                        columns: ':not(.not-export)'
                    },
