                        ...
                        <div class="card card-invoice">
                            <div class="card-header" style="width: 95% !important;">
                                <div class="invoice-header">
                                    <div>
                                        <h3 class="invoice-title">Annexure-II</h3>
                                        <div class="pull-left">
                            ...
                            <div class="card-body mt-3" style="width: 95% !important;">
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="text-align: center;">
                                        <h4><b>Current Fund Requisition</b></h4>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table id="tbl" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><?= $curr->claimed_amt ?></td>
                                                        <td><?= $curr->dpr_amt ?></td>
                                                        <td><?= $curr->contigency_amt ?></td>
                                                        <td><?= ($curr->claimed_amt + $curr->dpr_amt + $curr->contigency_amt) ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
