                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type='number' id="wp_progress" name="wp_progress" class="form-control number" placeholder="progress percentage" value="<?= $wp->physical_progress ?>" min="<?= $wp->physical_progress ?>" step="1" min="1" max="100" required>
...
<script>
    document.getElementById('wp_progress').addEventListener('input', function() {
