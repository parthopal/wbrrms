            ...
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <hr>
                        <?php echo form_open('ridf/qm_entry'); ?>
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="year" id="year" class="form-control dropdown">
                                        ...
                                        <option value="2025" <?= $selected->year == '2025' ? 'selected' : '' ?>>2025</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-2">
    ...
    <div class="page-inner mt--5">
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <?php echo form_open('ridf/qm_save'); ?>
                                ...
                                <tbody>
                                    ...
                                    if (sizeof($scheme) > 0) {
                                        foreach ($scheme as $row) {
                                            ...
                                            echo '<td>' . $row->cnt . '</td>';
                                            echo '<td>' . ($row->inspection_date != null ? date('d/m/Y', strtotime($row->inspection_date)) : '') . '</td>';
                                            echo '<td>' . $row->overall_grade . '</td>';
                                            echo '<td>' . ($row->atr_action == 0 ? 'Verification' : ($row->atr_action == 1 ? 'Accepted' : ($row->atr_action == -1 ? 'Rejected' : ''))) . '</td>';
