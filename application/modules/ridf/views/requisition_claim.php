            ...
            <div class="col-md-12 ">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('ridf/requisition_claim_save'); ?>
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mx-auto">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="claimed_doc" class="form-control dropify" data-max-file-size="2M" accept="application/pdf">
                                        </div>
                                    </div>
                                </div>
                            </div>
